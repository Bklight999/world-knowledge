...
#WEB_IP=9.135.120.204:8833  # web-browser server
WEB_IP=localhost:3001  # web-browser server
LLM_URL=http://29.81.242.25:8080/v1/chat/completions  # vllm model server
...
LLM_URL=http://29.81.242.25:8080/v1/chat/completions  # vllm model server
VLM_URL=http://29.81.242.25:8081/v1/chat/completions  # for VLM
