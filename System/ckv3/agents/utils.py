...
# rprint
# rprint通过rich.console.print实现彩色输出
...
#提供一种新的编码方式，将可以转成字典的对象转成字典，否则转成字符串
...
# 访问某个网站似乎用的就是这个功能，可以调高max_times来提高重试次数
...
class CodeExecutor:
    ...
    #如果代码执行错误，输出具体执行错误的那一行代码，以及错误信息
    @staticmethod
